...
module.exports = function(sequelize, DataTypes) {
  ...
  Collaborators.findByAppNameAndUid = function (uid, appName) {
    var sql = "SELECT b.*,type FROM `apps` as a left join `collaborators` as b  on (a.id = b.appid) where a.name= :appName and b.uid = :uid and a.`deleted_at` IS NULL and b.`deleted_at` IS NULL limit 0,1";
